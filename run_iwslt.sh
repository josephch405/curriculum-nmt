...
if [ "$1" = "train" ]; then
	...
	python run.py train --train-src=./data/iwslt/fr-en/train.fr-en.fr --train-tgt=./data/iwslt/fr-en/train.fr-en.en --dev-src=./data/iwslt/fr-en/IWSLT16.TED.tst2013.fr-en.fr --dev-tgt=./data/iwslt/fr-en/IWSLT16.TED.tst2013.fr-en.en --vocab=iwslt_vocab.json
...
train, dev, test = iwslt_dataset(language_extensions=['fr', 'en'], train=True, dev=True, test=True)"
	...
	python vocab.py --train-src=./data/iwslt/fr-en/train.fr-en.fr --train-tgt=./data/iwslt/fr-en/train.fr-en.en iwslt_vocab.json --freq-cutoff 5
else
